...
const Tickets = () => {
    return (
        <div className="bg-alepurple container mx-auto p-6 md:p-10 m-4">
            <h1 className="text-2xl md:text-4xl lg:text-5xl font-bold mybasetext">Get Your Kirkenes Film Festival Tickets</h1>
            ...
            <ul className="list-disc list-inside text-base md:text-lg mybasetext mt-2">
