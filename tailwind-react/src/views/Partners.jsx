...
const Partners = () => {
    return (
        <div className="bg-alepurple container mx-auto p-6 md:p-10 m-4">
            <h1 className="text-3xl md:text-4xl font-bold mybasetext">Our Festival Partners</h1>
            ...
            <div className="mt-6">
                <h2 className="text-xl md:text-2xl font-semibold mybasetext">Platinum Partners</h2>
            ...
            <div className="mt-6">
                <h2 className="text-xl md:text-2xl font-semibold mybasetext">Gold Partners</h2>
                <ul className="list-disc list-inside mybasetext mt-4">
            ...
            <div className="mt-6">
                <h2 className="text-xl md:text-2xl font-semibold mybasetext">Media Partners</h2>
                <ul className="list-disc list-inside mybasetext mt-4">
            ...
            <div className="mt-6">
                <h2 className="text-xl md:text-2xl font-semibold mybasetext">Community Partners</h2>
                <ul className="list-disc list-inside mybasetext mt-4">
