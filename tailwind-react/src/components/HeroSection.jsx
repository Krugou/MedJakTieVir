  ...
  return (
    <section className="bg-cover bg-center bg-aurora bg-no-repeat p-4 border rounded h-96 md:h-auto py-20">
      <div className="container mx-auto text-center">
        <h2 className="text-xl md:text-4xl lg:text-5xl font-bold mybasetext mb-4">Under the Northern Lights</h2>
        ...
        <a href="/tickets" className="inline-block bg-alecharcoal hover:bg-alepurple text-white font-bold py-3 px-6 rounded-full mt-4">
          Buy tickets
        </a>
      </div>
    </section>
